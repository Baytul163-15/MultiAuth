		...
		<div class="row  wow fadeInUp">            
			...
			<div class='col-sm-6 col-md-7 product-info-block'>
				<div class="product-info">
					<h1 class="name">
					@if(session()->get('language') == 'hindi') {{ $products->product_name_hin }} @else {{ $products->product_name_en }} @endif</h1>
					...
					<div class="description-container m-t-20">
						@if(session()->get('language') == 'hindi') {{ $products->short_descp_hin }} @else {{ $products->short_descp_en }} @endif
					...
					<div class="tab-content">
						...
						<div id="description" class="tab-pane in active">
							<div class="product-tab">
								<p class="text">@if(session()->get('language') == 'hindi') {!! $products->long_descp_hin !!} @else {!! $products->long_descp_en !!} @endif</p>
							</div>	
						</div><!-- /.tab-pane -->
