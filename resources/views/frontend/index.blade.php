    ...
    <div class="container">
      <div class="row"> 
                        ...
                        <div class="col-sm-12 col-md-3">
                          ...
                          <ul class="links list-unstyled">
                            <li><a href="#">@if(session()->get('language') == 'hindi') 
                              {{ $subsubcategory->subsubcategory_name_hin }} @else {{ $subsubcategory->subsubcategory_name_en }} @endif</a></li>
                          </ul>
                          @endforeach
                        </div>
                        <!-- /.col -->
        ...
        <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder"> 
              ...
              <div class="item" style="background-image: url({{ asset($slider->slider_img) }});">
                <div class="container-fluid">
                  <div class="caption bg-color vertical-center text-left">
                    ...
                    <div class="excerpt fadeInDown-2 hidden-xs"> <span style="color:red;">{{ $slider->description }}</span> </div>
          ...
          <div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
            <div class="more-info-tab clearfix ">
              ...
              <ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
                ...
                @if(session()->get('language') == 'hindi') {{ $category->category_name_hin }} @else {{ $category->category_name_eng }} @endif</a></li>
                @endforeach
          ...
          {{-- Skip Category Fession Section --}}
          <section class="section featured-product wow fadeInUp">
            <h3 class="section-title">
              @if(session()->get('language') == 'hindi') {{ $scape_category_6->category_name_hin }} @else {{ $scape_category_6->category_name_eng }} @endif</h3> 
            <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">

              @foreach($scape_product_6 as $product)
              <div class="item item-carousel">
                <div class="products">
                  <div class="product">
                    <div class="product-image">
          ...
          {{-- Skip Category Electronic Section --}}
          <section class="section featured-product wow fadeInUp">
            <h3 class="section-title">
              @if(session()->get('language') == 'hindi') {{ $scape_category_1->category_name_hin }} @else {{ $scape_category_1->category_name_eng }} @endif</h3> 
            <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">

              @foreach($scape_cat_product_1 as $product)
              <div class="item item-carousel">
                <div class="products">
                  <div class="product">
                    <div class="product-image">
          ...
          {{-- Skip Brand Samsung Section --}}
          <section class="section featured-product wow fadeInUp">
            <h3 class="section-title">
              @if(session()->get('language') == 'hindi') {{ $scape_brand_1->brand_name_hin }} @else {{ $scape_brand_1->brand_name_eng }} @endif</h3> 
            <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">

              @foreach($scape_brand_product_1 as $product)
              <div class="item item-carousel">
                <div class="products">
                  <div class="product">
                    <div class="product-image">
